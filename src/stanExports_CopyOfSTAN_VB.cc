...
#include "stanExports_CopyOfSTAN_VB.h"

RCPP_MODULE(stan_fit4CopyOfSTAN_VB_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_CopyOfSTAN_VB")
