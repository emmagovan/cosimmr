...
library(ggplot2)
ggplot(data = df_plot, aes(x = Group, y = samples, colour = Group))  + geom_boxplot() + ggtitle("Zostera consumed by each group") +xlab("Group") + ylab("Proportion of Zostera consumed")
