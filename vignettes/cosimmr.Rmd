...
ggplot(data = df_plot, aes(x = Group, y = samples, colour = Group))  + geom_boxplot() + ggtitle("Boxplot of XXX consumed by each group") +xlab("Group") + ylab("mean proportion of XXX consumed")
